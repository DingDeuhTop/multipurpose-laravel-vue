    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">
                        <span v-if="editMode">Edit Appointment</span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.start_time" type="text" class="form-control flatpickr"
                                                id="start_time" :class="{ 'is_valid': errors.start_time }">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.end_time" type="text" class="form-control flatpickr"
                                                id="end_time" :class="{ 'is_valid': errors.end_time }">
